...
from modules.auto_rag.mod import ChromaDBManager, RawDataSyncManager
...
class DocumentService:
    def __init__(self):
        ...
        # RawDataSyncManager에도 설정된 경로 전달
        raw_data_path = str(settings.get_raw_data_path())
        self.sync_manager = RawDataSyncManager(raw_data_path=raw_data_path)
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        if db_status["db_exists"] and not db_status["db_loaded"]:
            ...
            db_status = self.db_manager.get_status()  # Refresh status after loading
