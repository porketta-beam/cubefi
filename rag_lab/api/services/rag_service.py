    ...
    def chat(self, question: str, model: str = "gpt-4o-mini", temperature: float = 0.0, 
        ...
        try:
            ...
            if not question.strip():
                return {
                    "answer": "❌ Empty question received. Please provide a valid question.",
                    "contexts": [],
                    "model_used": model,
                    "search_params": {},
                    "success": False
            ...
            if not db_status["db_exists"]:
                return {
                    "answer": "❌ No vector database found. Please upload documents first using /api/documents/sync or /api/documents/upload",
                    "contexts": [],
                    "model_used": model,
                    "search_params": {},
                    "success": False
            ...
            if db_status["document_count"] == 0:
                return {
                    "answer": "❌ Vector database is empty. Please upload documents first using /api/documents/sync or /api/documents/upload",
                    "contexts": [],
                    "model_used": model,
                    "search_params": {},
                    "success": False
            ...
            if not db_status["db_loaded"]:
                try:
                    ...
                    return {
                        "answer": f"❌ Failed to load vector database: {str(e)}",
                        "contexts": [],
                        "model_used": model,
                        "search_params": {},
                        "success": False
            ...
            if not answer.strip():
                return {
                    "answer": "❌ Empty answer generated. Please try rephrasing your question.",
                    "contexts": contexts,
                    "model_used": model,
                    "search_params": {
