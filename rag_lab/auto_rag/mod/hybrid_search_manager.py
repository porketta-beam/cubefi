...
class HybridSearchManager:
    ...
    def reciprocal_rank_fusion(self, 
        ...
        # Vector search results에 RRF 스코어 추가
        ...
        # BM25 search results에 RRF 스코어 추가
    ...
    def hybrid_search(self, query: str, k: int = 5, rrf_k: int = 60) -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
        """
        ...
        try:
            ...
            if vector_results and bm25_results:
                hybrid_results = self.reciprocal_rank_fusion(vector_results, bm25_results, rrf_k)
